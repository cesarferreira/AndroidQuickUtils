package quickutils.core.util.text;
...
//	}
	 ...
	 * 
	 * @param startLorem
	 *            whether to start with standard lorem ipsum text or not
	 ...
	 * 
	 * @param maxSentences
	 *            maximum number of sentences to include in paragraph
	 * @param startLorem
	 *            whether to start first paragraph with standard lorem ipsum
	 *            text or not.
	 * @return generated paragraph
	 ...
	 * @param delimiter
	 *            the delimiter that will be used to merge items in array
