 ...
 * any methods. Use {@link google.common.collect.CustomConcurrentHashMap.Builder} to create a custom concurrent hash map
 * instance. Client libraries implement {@link google.common.collect.CustomConcurrentHashMap.Strategy}, and this class
 ...
 * {@link google.common.collect.CustomConcurrentHashMap.Builder#buildComputingMap(google.common.collect.CustomConcurrentHashMap.ComputingStrategy, Function)}
 * ).
 * <p>
...
final class CustomConcurrentHashMap {
    ...
    public interface Strategy<K, V, E> {
         ...
         * that was provided to {@link google.common.collect.CustomConcurrentHashMap.Strategy#newEntry} when the given entry
         * was created.
         * 
         * @return the next entry or null if null was passed to
         *         {@link google.common.collect.CustomConcurrentHashMap.Strategy#newEntry}
         */
        E getNext(E entry);

        /**
         * Returns the hash code that was passed to {@link google.common.collect.CustomConcurrentHashMap.Strategy#newEntry})
    ...
    /**
     * Extends {@link google.common.collect.CustomConcurrentHashMap.Strategy} to add support for computing values on-demand.
     ...
     * 
     * @see google.common.collect.CustomConcurrentHashMap.Builder#buildComputingMap(google.common.collect.CustomConcurrentHashMap.ComputingStrategy,
     *      Function)
     */
    public interface ComputingStrategy<K, V, E> extends Strategy<K, V, E> {
         ...
         *        that was created
         * @param computer
         *        passed to {@link google.common.collect.CustomConcurrentHashMap.Builder#buildMap}
     ...
     * {@link google.common.collect.CustomConcurrentHashMap.SimpleInternalEntry}. Intended to be subclassed to provide
    ...
    /**
     * A basic, no-frills entry class used by {@link google.common.collect.CustomConcurrentHashMap.SimpleInternalEntry}.
     */
